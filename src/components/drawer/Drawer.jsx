...
export default function Drawer({drawer}){
    return(
        <div className={`${drawer ? "translate-x-[0px] " : "translate-x-[-700px]" } visible lg:invisible  bg-[#141414] w-[70%] text-white  fixed z-20 bottom-0 left-0 top-0 transition-all duration-800 ease-in-out z-20`}>
